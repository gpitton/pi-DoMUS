#include "interfaces/navier_stokes_explicit.h"
...
#define problem_NS(dynamic,dim,spacedim,LAC) \
  NavierStokesExplicit<dim,spacedim,LAC> energy(dynamic); \
...
int main (int argc, char *argv[])
{
  ...
  std::string pde_name="navier_stokes_explicit";
  ...
  // int spacedim = 2;
  // My_CLP.setOption("spacedim", &spacedim, "dimension of the whole space");
  ...
  std::string string_pde_name = "Navier Stokes";
